...
public class StockServiceImpl implements StockService {
    ...
    public StockPriceResponse geStockPriceById(Long stockId) {
        ...
        response.setStatusMessage("Fetched the Stocks price history Successfully");
    ...
    public StockDetailsResponse createStock(StockRequest stockRequest) {
        ...
        stock.setCurrentPrice(stockRequest.getCurrentPrice() * currencyService.getConversionRateToBaseCurrency(stockRequest.getCurrencyCode()));
        ...
        stock.setLastUpdated(stockRequest.getLastUpdated() == null ? StocksUtil.getCurrentTimestamp(): stockRequest.getLastUpdated());
    ...
    public StockDetailsResponse updateStockPrice(StockPriceRequest stockPriceRequest) {
        ...
        Timestamp tz = stockPriceRequest.getLastUpdated() == null ? StocksUtil.getCurrentTimestamp(): stockPriceRequest.getLastUpdated();
        stock.setLastUpdated(tz);
        stock.setCurrentPrice(stockPriceRequest.getCurrentPrice() * currencyService.getConversionRateToBaseCurrency(stockPriceRequest.getCurrencyCode()));
        stock.setCurrencyCode(stockPriceRequest.getCurrencyCode());
        stockRepository.updateStockPrice(stockPriceRequest.getStockId(), stockPriceRequest.getCurrentPrice(), stockPriceRequest.getCurrencyCode(), tz);
